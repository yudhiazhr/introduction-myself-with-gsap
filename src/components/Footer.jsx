const Footer = () => {
    return(
        <>
        <footer className="bg-dark py-12 mx-auto overflow-hidden">
        <div className="flex flex-col">
          <div className="grid lg:grid-cols-2 justify-items-center mb-12">
            <div className="flex flex-col w-[300px] mb-8">
              <h1 className="text-white text-3xl md:text-4xl font-bold font-spaceGrotesk mb-4">
                Contact
              </h1>
